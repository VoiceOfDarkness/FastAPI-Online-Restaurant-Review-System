...
from utils.custom_routes import DecryptContentRoute

dec_router = APIRouter()
dec_router.route_class = DecryptContentRoute
...
@dec_router.post('/login/decrypt/details')
...
@dec_router.post('/restaurant/decrypt/details')
