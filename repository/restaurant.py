...
from models.data.orrs import AmbienceRating, Feedback, FoodRating, Restaurant
...
class RestaurantRepository:
    ...
    async def insert_restaurant(self, details: Dict[str, Any]):
        try:
    ...
    async def update_restaurant(self, id: int, details: Dict[str, Any]):
        try:
    ...
    async def delete_restaurant(self, id: int):
        try:
            restaurant = await self.engine.find_one(Restaurant, Restaurant.restaurant_id == id)
